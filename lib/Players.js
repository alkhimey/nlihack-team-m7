...
Players.prototype.setAnswer = function(playerId, answer) {
    if (this.players[playerId])  {
        this.players[playerId].answer = answer;
    }
}

Players.prototype.updatePoints = function(real_answer) {

    for (var key in this.players)
    {
        if(this.players[key].answer == real_answer) 
        {
...
Players.prototype.clearAnswers = function() {

    for (var key in this.players)
    {    
        this.players[key].answer = -1;      
    }
}
